...
public class Teachers_Information_System extends javax.swing.JFrame {
    ...
    private void cmd_tsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmd_tsaveActionPerformed
        ...
        String teacherId = txt_teacher_ID.getText().trim();
        String teacherFName = txt_firstname.getText().trim();
        String teacherLName = txt_lastname.getText().trim();
        String teacherPosition = txt_position.getText().trim();
        String teacherBirth = txt_birthday.getText().trim();
        String teacherMobile = txt_mobile.getText().trim();
        String teacherSex = txt_sex.getText().trim();
        String teacherPermanent = txt_permanent.getText().trim();
        String teacherPresent = txt_present.getText().trim();
          
       if(!teacherId.isEmpty() && !teacherFName.isEmpty() && !teacherBirth.isEmpty()
               && !teacherMobile.isEmpty() && !teacherPosition.isEmpty() && !teacherPermanent.isEmpty()
               && !teacherPresent.isEmpty() && !teacherSex.isEmpty()){
        ...
        try {
           ...
           JOptionPane.showMessageDialog(null,"Please fill all compulsory fields");
       }
    ...
    private void txt_tupdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txt_tupdateActionPerformed
        ...
        if(!teacherId.isEmpty() && !teacherFName.isEmpty() && !teacherBirth.isEmpty()
            ...
            JOptionPane.showMessageDialog(null,"Please add All compulsory fields");
        }
