...
public class Employees_Infromation_System extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txt_emp_ID.setToolTipText("Enter Six Digit ID number");
...
//        }
    ...
    private void cmd_tsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmd_tsaveActionPerformed
        ...
        String empId = txt_emp_ID.getText().trim();
        String empFName = txt_firstname.getText().trim();
        String empLName = txt_lastname.getText().trim();
        String empPosition = txt_position.getText().trim();
        String empBirth = txt_birthday.getText().trim();
        String empMobile = txt_mobile.getText().trim();
        String empSex = txt_sex.getText().trim();
        String empPermanent = txt_permanent.getText().trim();
        String empPresent = txt_present.getText().trim();
        
         if(!empId.isEmpty() && !empFName.isEmpty() && !empBirth.isEmpty()
               && !empMobile.isEmpty() && !empPosition.isEmpty() && !empPermanent.isEmpty()
               && !empPresent.isEmpty() && !empSex.isEmpty()){
