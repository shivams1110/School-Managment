...
//            JOptionPane.showMessageDialog(null,"We face a Problem.");
    ...
    private void cmd_saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmd_saveActionPerformed
        ...
        String studentId = txt_roll.getText().trim();
        String studentFName = txt_firstname.getText().trim();
        String studentLName = txt_lastname.getText().trim();
        String studentClass = txt_classname.getText().trim();
        String studentYear = txt_year.getText().trim();
        String studentBirth = txt_birthday.getText().trim();
        String studentMobile = txt_mobile.getText().trim();
        String studentSex = txt_sex.getText().trim();
        String studentPermanent = txt_permanent.getText().trim();
        String studentPresent = txt_present.getText().trim();
        
         if(!studentId.isEmpty() && !studentFName.isEmpty() && !studentBirth.isEmpty()
               && !studentMobile.isEmpty() && !studentYear.isEmpty() && !studentPermanent.isEmpty()
               && !studentPresent.isEmpty() && !studentSex.isEmpty() && !studentClass.isEmpty()){
               ...
               && !studentPresent.isEmpty() && !studentSex.isEmpty() && !studentClass.isEmpty()){
                ...
                if(p==0){
                   try {
                        ...
                        String sql1="select  * from  student_info where Roll=?";
    ...
    private void cmd_deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmd_deleteActionPerformed
        // TODO add your handling code here:
         ...
         if(!txt_roll.getText().trim().isEmpty()){
